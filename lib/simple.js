...
export function HelperConnection(conn, { store, logger }) {
	...
	let sock = Object.defineProperties(conn, {
		...
		sendFile: {
			 ...
			 */
			async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
		...
		sendContact: {
			 ...
			 * @param {Object} options 
			 */
			async value(jid, data, quoted, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
...
`.trim()
		...
		reply: {
			 ...
			 * @param {Object} options
			 */
			value(jid, text = '', quoted, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
		...
		sendButton: {
			 ...
			 * @param {Object} options
			 */
			async value(jid, text = '', footer = '', buffer, buttons, quoted, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
				let file
		...
		sendHydrated: {
			 ...
			 * @param {Object} options
			 */
			async value(jid, text = '', footer = '', buffer, url, urlText, call, callText, buttons, quoted, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
				let file
				if (buffer) {
					try {
						file = await conn.getFile(buffer)
		...
		sendList: {
			async value(jid, title, text, footer, buttonText, buffer, listSections, quoted, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
		...
		cMod: {
			 ...
			 * @returns 
			 */
			value(jid, message, text = '', sender = conn.user.jid, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
		...
		copyNForward: {
			 ...
			 * @param {Object} options
			 */
			async value(jid, message, forwardingScore = true, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
				let vtype
		...
		fakeReply: {
			 ...
			 */
			value(jid, text = '', fakeJid = this.user.jid, fakeText = '', fakeGroupJid, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
		...
		sendGroupV4Invite: {
			 ...
			 * @param {*} options 
			 */
			async value(jid, participant, inviteCode, inviteExpiration, groupName = 'unknown subject', caption = 'Invitation to join my WhatsApp group', jpegThumbnail, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
			...
			get() {
				...
				return Object.defineProperties(JSON.parse(JSON.stringify(typeof q === 'string' ? { text: q } : q)), {
					...
					reply: {
						 ...
						 * @param {Object} options
						 */
						value(text, chatId, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
					...
					forward: {
						 ...
						 */
						value(jid, force = false, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
					...
					copyNForward: {
						 ...
						 * @param {Object} options
						 */
						value(jid, forceForward = false, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
					...
					cMod: {
						 ...
						 * @param {Object} options
						 */
						value(jid, text = '', sender = this.sender, options = { ephemeralExpiration: WA_DEFAULT_EPHEMERAL }) {
